...
- LOCATION (use to address any JD that names a city or requires onsite/hybrid/in-office work): based in New York City, NY, and open to relocation, including for onsite or hybrid roles in other cities. The truthful way to address a located/hybrid role is openness to relocating there. NEVER state or imply the candidate already lives in, or is local to, a target company's city, or already works hybrid from it; that is a fabrication and will be blocked. When unsure, omit location rather than invent it.
